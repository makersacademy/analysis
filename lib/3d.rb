...
plot.export_html("graph/wireframe.html")

# Surface
plot = Nyaplot::Plot3D.new
plot.add(:surface, x, y, z)
plot.export_html("graph/surface.html")
...
plot.export_html("graph/3dline.html")
...
plot.export_html("graph/3dscatter.html")
...
plot.export_html("graph/particles.html")